...
export default function MenuBar({ duration, setDuration, dotted, setDotted, triplet, setTriplet, slur, setSlur, bowing, setBowing, addRest, accidental, setAccidental, isMuted, setIsMuted, isPlaying, startPlayback, stopPlayback, tempo, setTempo, hasNotes, noteCount, notes, setNotes, selectedIdx, setSelectedIdx, updateSelectedNote, noteSystem, setNoteSystem, timeSignature, setTimeSignature, hideLabels, setHideLabels, showShortcuts, setShowShortcuts, saveScore, openScore, onAfterChange }) {
  ...
  const SHORTCUT_GROUPS = [
    {
      title: t("shortcuts.groupDurations"),
      items: [
        { label: t("shortcuts.sixteenth"), keys: ["1"] },
        { label: t("shortcuts.eighth"), keys: ["2"] },
    ...
    },
    {
      ...
      items: [
        { label: t("shortcuts.playStop"), keys: ["P"] },
    ...
    },
    {
      ...
      items: [
        { label: t("shortcuts.notation"), keys: ["0"] },
        { label: t("shortcuts.labels"), keys: ["?"] },
        { label: t("shortcuts.timeSignature"), keys: ["/"] },
        { label: t("shortcuts.language"), keys: ["L"] },
        { label: t("shortcuts.title"), keys: ["K"] },
      ],
    },
    {
      title: t("shortcuts.groupEdit"),
      items: [
        { label: t("shortcuts.delete"), keys: [{ type: "backspace" }] },
        { label: t("shortcuts.clearScore"), keys: [{ type: "shift" }, { type: "backspace" }] },
        { label: t("shortcuts.save"), keys: [{ type: "shift" }, "S"] },
        { label: t("shortcuts.open"), keys: [{ type: "shift" }, "O"] },
      ],
    },
  ];
      ...
      {showShortcuts && (
        <div className="shortcuts-overlay" onClick={() => setShowShortcuts(false)}>
          <div className="shortcuts-overlay__content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="shortcuts-overlay__divider" />
            <div className="shortcuts-overlay__columns">
              {SHORTCUT_GROUPS.map((group, gi) => (
                <div key={gi} className="shortcuts-overlay__group">
                  <div className="shortcuts-overlay__group-title">{group.title}</div>
                  {group.items.map((s, i) => (
                    <div key={i} className="shortcuts-overlay__item">
                      ...
                      <span className="shortcuts-overlay__keys">
                        {s.keys.map((k, ki) => (
                          typeof k === "object" && k.type === "shift" ? (
                            <span key={ki} className="shortcuts-overlay__key">
                              <svg viewBox="0 0 11 9" width="11" height="9" aria-hidden="true">
                                <path d={SHIFT_PATH} fill="#fff" />
                              </svg>
                            </span>
                          ) : typeof k === "object" && k.type === "backspace" ? (
                            <span key={ki} className="shortcuts-overlay__key">
                              <svg viewBox="0 0 11 9" width="11" height="9" aria-hidden="true">
                                <path d={BACKSPACE_PATH} fill="#fff" />
                              </svg>
                            </span>
                          ) : typeof k === "object" && k.type === "space" ? (
                            <span key={ki} className="shortcuts-overlay__key shortcuts-overlay__key--space">{k.label}</span>
                          ) : (
                            <span key={ki} className="shortcuts-overlay__key">{k}</span>
                          )
                        ))}
                      </span>
                    </div>
